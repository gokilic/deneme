...
OQS_STATUS OQS_KEX_rlwe_newhope_alice_0(OQS_KEX *k, void **alice_priv,
                                        uint8_t **alice_msg, size_t *alice_msg_len);
OQS_STATUS OQS_KEX_rlwe_newhope_bob(OQS_KEX *k, const uint8_t *alice_msg,
                                    const size_t alice_msg_len, uint8_t **bob_msg,
                                    size_t *bob_msg_len, uint8_t **key,
                                    size_t *key_len);
OQS_STATUS OQS_KEX_rlwe_newhope_alice_1(OQS_KEX *k, const void *alice_priv,
