 ...
 *
 * Abstract: Finite field arithmetic for ARM64 using code modified from the
 *original x86_64
 *           and generic implementations by Microsoft.
 *
 *           Most of this file is just a wrapper for the asm file. The other
 *routines are
...
void oqs_sidh_cln16_rdc_mont(const digit_t *ma,
                             digit_t *mc) { // Efficient Montgomery reduction
	                                        // using comba and exploiting the
	                                        // special form of the prime p751.
