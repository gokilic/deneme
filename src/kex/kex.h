...
typedef struct OQS_KEX {
   ...
   * @param alice_msg        Alice's message (public key + optional additional
   * data)
   ...
   * data)
   * @param alice_msg_len    Alice's message length
   * @param bob_msg          Bob's message (public key / encryption of shared
   * key + optional additional data)
 ...
 *                           to use for this instance (as a NULL-terminated C
 * string),
 *                           if any, or NULL.
