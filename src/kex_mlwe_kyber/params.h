...
#define KYBER_INDCPA_PUBLICKEYBYTES \
	(KYBER_POLYVECCOMPRESSEDBYTES + KYBER_SEEDBYTES)
...
#define KYBER_SECRETKEYBYTES                                          \
	(KYBER_INDCPA_SECRETKEYBYTES + KYBER_INDCPA_PUBLICKEYBYTES + 32 + \
	 KYBER_SHAREDKEYBYTES)
#define KYBER_BYTES       \
	(KYBER_INDCPA_BYTES + \
	 KYBER_INDCPA_MSGBYTES) /* Second part is for Targhi-Unruh */
