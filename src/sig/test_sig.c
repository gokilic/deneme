...
static OQS_STATUS
sig_test_correctness(OQS_RAND* rand, enum OQS_SIG_algid algid, const int print)
{
...
sig_test_correctness_wrapper(OQS_RAND* rand, enum OQS_SIG_algid algid,
...
sig_bench_wrapper(OQS_RAND* rand, enum OQS_SIG_algid algid, const int seconds)
{
    ...
    TIME_OPERATION_SECONDS({ OQS_SIG_keygen(s, priv, pub); }, "keygen",
                           seconds);
    ...
    TIME_OPERATION_SECONDS({
                               OQS_SIG_sign(s, priv, msg, msg_len, sig,
                                            &sig_len);
                               sig_len = s->max_sig_len;
                           }, "sign", seconds);
    ...
    TIME_OPERATION_SECONDS(
            { OQS_SIG_verify(s, pub, msg, msg_len, sig, sig_len); }, "verify",
            seconds);
