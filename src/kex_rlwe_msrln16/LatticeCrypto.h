/***************************************************************************************
* LatticeCrypt: an efficient post-quantum Ring-Learning With Errors cryptography
*library
*
...
// It computes the shared secret SharedSecretA using Bob's public key PublicKeyB
// and Alice's private key SecretKeyA.
