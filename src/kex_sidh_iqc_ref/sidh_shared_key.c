...
void oqs_sidh_iqc_ref_shared_key_generate(fp2_element_t shared_key,
	...
	oqs_sidh_iqc_ref_private_key_compute_kernel_gen(kernel_gen, private_key,
	                                                public_key->P, public_key->Q,
	                                                params->le, public_key->E);
	elliptic_curve_t E;
	oqs_sidh_iqc_ref_elliptic_curve_init(E);
	oqs_sidh_iqc_ref_elliptic_curve_set(E, public_key->E);

	oqs_sidh_iqc_ref_isogeny_evaluate_strategy_curve(E, kernel_gen, params->l,
	                                                 params->e, 0.5);
	//    oqs_sidh_iqc_ref_isogeny_evaluate_naive_curve(E, kernel_gen, params->l,
	//    params->e, 3);
